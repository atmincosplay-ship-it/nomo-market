...
local VERSION = "UI TEST V1 OBSIDIAN"
...
-- NOMO Market UI Test V1 (custom Obsidian-inspired shell)
...
local T = {
	BG        = Color3.fromRGB(5, 5, 9),
	Sidebar   = Color3.fromRGB(9, 8, 15),
	Card      = Color3.fromRGB(12, 10, 20),
	Card2     = Color3.fromRGB(18, 15, 29),
	Border    = Color3.fromRGB(68, 45, 108),
	Accent    = Color3.fromRGB(139, 92, 246),
	AccentSoft= Color3.fromRGB(30, 22, 48),
	Text      = Color3.fromRGB(241, 237, 248),
	Sub       = Color3.fromRGB(151, 140, 168),
	Green     = Color3.fromRGB(52, 199, 123),
	Yellow    = Color3.fromRGB(235, 190, 80),
	Red       = Color3.fromRGB(240, 85, 85),
	Toggle0   = Color3.fromRGB(48, 43, 63),
}
...
function Library:CreateWindow(cfg)
	...
	-- Obsidian-style launcher: compact button opens the full window.
	local mini = make("TextButton", {
		Size = cfg.MiniSize or UDim2.fromOffset(96, 36),
		Position = cfg.MiniPosition or UDim2.fromOffset(4, 4),
		BackgroundColor3 = Color3.fromRGB(5, 25, 7),
		Text = cfg.MiniText or "NOMO",
		TextColor3 = Color3.fromRGB(255, 255, 0),
		Font = Enum.Font.GothamBold,
		TextSize = 14,
		BorderSizePixel = 0,
		Visible = cfg.StartMinimized == true,
		Active = true,
	}, gui)
	corner(mini, cfg.MiniCorner or 4)
	stroke(mini, Color3.fromRGB(0, 170, 0), 0)
	...
	setMinimized(cfg.StartMinimized == true)
...
local win = Library:CreateWindow({
    ...
    -- Obsidian-style small launcher button.
    MiniPosition = UDim2.fromOffset(4, 4),
    MiniSize = UDim2.fromOffset(96, 36),
    MiniCorner = 4,
